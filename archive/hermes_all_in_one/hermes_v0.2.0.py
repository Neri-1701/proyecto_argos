...
# =========================================================
# RESOURCE_PATH — ruta local real, compatible con .pyw y .exe
# =========================================================
...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        tk.Button(
            self.invf, text="Cargar Inventario (.xlsx)",
        ...
        tk.Button(
            self.visf, text="Cargar Visiflex (.xlsx)",
            bg=accent, fg=fg, relief="flat",
            command=self.load_visiflex
        ).pack(pady=5, anchor="w")
        ...
        tk.Button(
            self.visf, text="Ejecutar asignación",
            bg=accent, fg=fg, relief="flat",
            command=self.run_thread
        ).pack(pady=20, anchor="w")

        # posicionamiento inicial del logo
